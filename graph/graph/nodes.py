...
回答は日本語で、簡潔かつ洞察に富む内容にしてください。200〜250字。"""),
    ...
    return {
        **state,
        "issue_analysis_result": response.content,
...
具体的な数字を使い、根拠も簡潔に示してください。200〜250字。"""),
    ...
    return {
        **state,
        "roi_estimation_result": response.content,
...
各フェーズの主要タスクと成功指標（KPI）を明示してください。200〜250字。"""),
    ...
    return {
        **state,
        "roadmap_result": response.content,
...
説得力があり、意思決定を促す内容にしてください。250〜300字。"""),
    ...
    return {
        **state,
        "final_proposal_result": response.content,
        "current_agent": "done",
    }
